...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Universal/2D Custom Lit No Double VerColor", false, 85 )]
		public static void ApplyTemplateUniversal2DCustomLitNoDoubleVerColor()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "27c2e37ef0ae0ed4ba9ce8c439224f0b" );
		}
